...
data = pd.read_csv('D:\Kuliah\Semester 5\Data Warehouse dan Data Mining\PYTHON\Dataset\Social_Network_Ads.csv')
...
from sklearn.naive_bayes import GaussianNB #pakai algoritma naive bayes
classifier = GaussianNB()
classifier.fit(x_train, y_train)

y_pred = classifier.predict(x_test)

from sklearn.metrics import confusion_matrix #untuk mengetahui akurasinya
